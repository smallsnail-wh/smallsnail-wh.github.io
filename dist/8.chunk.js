...
Component.options.__file = "F:\\githubpage\\src\\views\\sys\\user.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-24f04310", Component.options)
  } else {
    hotAPI.reload("data-v-24f04310", Component.options)
  }
})()}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        /*页面初始化调用方法*/
        this.data1 = [{ "id": 3, "loginName": "test2", "name": "小刚", "password": "{bcrypt}$2a$10$1Bz7ykaiENOwY7/sFadXVO/CvWrlNOYvJrn/PFDsCN.hXJ64mTtjq", "email": "123@qq.com" }, { "id": 2, "loginName": "test1", "name": "小明", "password": "{bcrypt}$2a$10$fA4Waq2cDWzVn4IkqfTiR.Xnm6Xm3BTGEL7vsLm36hAqJ.M5Dvjci", "email": "123456@qq.com" }, { "id": 1, "loginName": "admin", "name": "管理员", "password": "{bcrypt}$2a$10$D8E4cuanLviCCe/ASqBC7OZ84JYOH8IT4/y4JLAV/Pm/AdhzPcy2.", "email": "123456@qq.com" }];
        this.total = 3;

        this.data2Temp = [{ "id": 1, "name": "管理员", "modules": "4;5;6;", "describe": "管理员" }, { "id": 2, "name": "test1", "modules": "7;", "describe": "测试1" }, { "id": 3, "name": "test2", "modules": "9;8;", "describe": "测试2" }];
    },
    ...
    methods: {
        ...
        relationSet: function relationSet(e) {
            ...
            var roleList = [];
            if (e.id == 1) {
                var data = [{ "userId": 1, "roleId": 1 }, { "userId": 1, "roleId": 2 }, { "userId": 1, "roleId": 3 }];
                for (var i in data) {
                    roleList.push(data[i].roleId);
                }
            } else if (e.id == 2) {
                var data = [{ "userId": 2, "roleId": 2 }];
                for (var i in data) {
                    roleList.push(data[i].roleId);
                }
            } else {
                var data = [{ "userId": 3, "roleId": 3 }];
                for (var i in data) {
                    roleList.push(data[i].roleId);
                }
            }
        ...
        info: function info() {
            this.$Notice.info({
                title: '此功能无法使用',
                desc: '此页面只用于展示项目的大概功能，无后台和数据库，所以涉及到后台数据交换的功能无法使用。敬请原谅',
                duration: 6
            });
        }
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-24f04310", module.exports)
  }
}
